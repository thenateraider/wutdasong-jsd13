...
class GameEngine {
    ...
    submitGuess(playerId, questionId, choiceId, timeRemainingSec) {
        ...
        if (!currentRound || currentRound.questionId !== questionId)
            return false;
    ...
    haveAllPlayersGuessed(activePlayerIds) {
